  ...
  <view class="sk-container">
      ...
      <view class="goods goods">
        ...
        <view class="meta meta">
          <view class="price price">
            ...
            <text class="number sk-transparent sk-text-14-2857-707 sk-text">238.00</text>
          </view>
          <view class="name ellipsis sk-transparent sk-text-14-2857-796 sk-text"
            >多米尼加陈年朗姆酒700毫升</view
          >
          <view class="desc sk-transparent sk-text-0-0000-831 sk-text">陈年朗姆，香味芬芳app</view>
        </view>
        <view class="action action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-857 sk-text">选择</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-674 sk-text">
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-747 sk-text">送至</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-910 sk-text">
              请选择收获地址
            </text>
          </view>
    ...
    <view class="toolbar toolbar" style="padding-bottom: 0px">
      ...
      <view class="buttons buttons">
        <view
          class="addcart sk-transparent sk-text-31-9444-10 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-31-9444-438 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
...
<style>
/*
此文件为开发者工具生成，生成时间: 2024/1/23下午3:17:24

在 C:\Users\子子杰\Desktop\webstudy_qf\mystudy\heima-小兔先-uni\mydemo\heima-shop\dist\dev\mp-weixin\pages\goods\goods.wxss 中引入样式
```
